...
class Adverts extends ClassInterface{
	...
	public function serve($type= 'text'){ 
		...
		$banner = ($type == 'banner') ? '["banner", "!=", "null"], "AND",' : '';
		
		$data = $this->_db->get($this->_table, 'id,matric,label,caption,details,link,banner,units', '[["approved", "=", "yes"], "AND", '. $banner . ' ["units", ">", "0"], "AND ( ", ["target", "=", "0"] , "OR", ["target", "=", "'.$faculty.'"], " ) ORDER BY RAND() LIMIT 1"]');
