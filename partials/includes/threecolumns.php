<div class="row-fluid">
  <div class="span4"> <img src="<?=url()?>assets/img/responsive.png" alt="Responsive">
    <h2> <span class="firstword">I am rock</span> Layout</h2>
  ...
  <div class="span4"> <img src="<?=url()?>assets/img/think-creative.png" alt="Think Creative">
  ...
  <div class="span4"> <img src="<?=url()?>assets/img/core-values.png" alt="Core Values">
